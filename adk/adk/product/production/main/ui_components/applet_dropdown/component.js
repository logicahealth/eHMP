    ...
    var Orig = dropdownView,
        Modified = Orig.extend({
            constructor: function() {
                ...
                className = _.isFunction(className) && !_.isEqual(className, Orig.prototype.className) ? className.call(this) : (_.isString(className) ? className : '');
                this.className = Orig.prototype.className.call(this) + (_.isEmpty(className) ? '' : ' ' + className);
