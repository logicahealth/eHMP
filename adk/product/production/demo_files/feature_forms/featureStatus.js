define([
    ...
    return [{
        ...
        workflowPath: "http://10.1.1.150/ui-components/docs/workflow/psi9/writebacks/f170-workflow-vital-eie.pdf",
        workflowSize: "338KB",
        useCaseScenarioPath: "http://10.1.1.150/ui-components/docs/use-case/psi9/writebacks/f170-use-case-vitals-eie.pdf",
        ...
        workflowPath: "http://10.1.1.150/ui-components/docs/workflow/psi8/writebacks/f226-f560-workflow-notes.pdf",
        workflowSize: "599KB",
        useCaseScenarioPath: "http://10.1.1.150/ui-components/docs/use-case/psi8/writebacks/f226-use-case-enter-plain-text-progress-notes.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f423-workflow-enter-and-store-a-vital.pdf",
        workflowSize: "498KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f423-use-case-enter-store-a-simple-vitals.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f413-workflow-encounters.pdf",
        workflowSize: "852KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f413-use-case-encounters.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f432-workflow-enter-and-store-a-simple-lab-order.pdf",
        workflowSize: "532KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f432-use-case-enter-and-store-simple-lab-order.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f360-workflow-enter-and-store-immunizations.pdf",
        workflowSize: "595KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f360-use-case-enter-and-store-immunizations.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f414-workflow-record-and-review-problem-list.pdf",
        workflowSize: "525KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f414-use-case-enter-record-review-problem-list.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f420-workflow-allergies.pdf",
        workflowSize: "666KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f420-use-case-enter-store-allergies.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi9/writebacks/f457-f662-workflow-user-management.pdf",
        workflowSize: "288KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi9/writebacks/f457-f662-use-case-user-management-applet.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f513-workflow-visit-management.pdf",
        workflowSize: "394KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f513-use-case-visit-management.pdf",
        ...
        workflowPath: "http://10.1.1.150/UI-Components/docs/workflow/psi8/writebacks/f568-workflow-e-signature-modal.pdf",
        workflowSize: "482KB",
        useCaseScenarioPath: "http://10.1.1.150/UI-Components/docs/use-case/psi8/writebacks/f568-use-case-eSignature-modal.pdf",
