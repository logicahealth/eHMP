            ...
            '<div class="row">',
                '<div class="well well-collapse">',
                    '<div class="collapsibleContainerHeader">',
                        ...
                        '<div class="col-xs-1">',
                            '{{#if collapse}}',
                                '<button data-buttonid="collapsibleContainerTrigger" class="btn btn-sm btn-icon collapsed left-margin-md top-margin-md all-padding-no font-size-18" title="Press enter to expand or collapse additional fields" type="button" data-collapse-button="true"></button>',
                            '{{/if}}',
                        '</div>',
                    '</div>',
