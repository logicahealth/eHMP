    ...
    return Backbone.Marionette.CompositeView.extend({
        ...
        initialize: function(options) {
            ...
            if (!(options.fields instanceof Backbone.Collection))
                options.fields = new Fields(options.fields || this.fields, { formView: this });
            ...
            var events = _.defaults({
                ...
                'form:view:update:bound:ui:elements': function(e, options) {
                    e.stopImmediatePropagation();
                    this.bindUIElements();
                    this.$el.trigger('form:view:updated:bound:ui:elements');
                }
            }, this.events);
