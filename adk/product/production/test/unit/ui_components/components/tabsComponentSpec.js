        ...
        describe('A tabs component', function() {
            ...
            describe('basic', function() {
                ...
                it('contains correct content per tab', function() {
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-1-tab-panel"]')).toHaveLength(1);
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-1-tab-panel"] div div')).toHaveText('tab 1 content');
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-2-tab-panel"]')).toHaveLength(1);
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-2-tab-panel"] div div')).toHaveText('tab 2 content');
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-3-tab-panel"]')).toHaveLength(1);
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-3-tab-panel"] div div')).toHaveText('tab 3 content');
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-4-tab-panel"]')).toHaveLength(1);
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-4-tab-panel"] div div')).toHaveText('tab 4 content');
                });
                it('displays tab content when tab is clicked', function() {
                    ...
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-1-tab-panel"]')).toHaveClass('active');
                    // click tab
                    ...
                    expect($tabsTestPage.find('.tab-content-container [id*="Tab-2-tab-panel"]')).toHaveClass('active');
                });
            });
