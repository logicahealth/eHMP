    ...
    function($, Handlebars, Backbone, Marionette, UI) {
        ...
        describe('A workflow component', function() {
            ...
            describe('basic', function() {
                ...
                it('header contains help icon when defined in step and is not present when not found in step', function() {
                    expect($('.header-btns button.help-icon-link')).toHaveLength(1);
                    $('#form1-next').click();
                    expect($('.header-btns button.help-icon-link')).toHaveLength(0);
