    ...
    describe('A nestedCommentBox control', function() {
        ...
        describe('basic', function() {
            ...
            it('contains correct number of columns', function() {
                expect($form.find('.control.nestedCommentBox-control .ncb-header-region > div')).toHaveLength(5);
                // will be one more than number of columns because of sr-only
            ...
            it('displays add comment link/button when no comments exist in that rows model', function() {
                expect($form.find('.control.nestedCommentBox-control .ncb-body-region .panel-container:nth-of-type(1) .panel:nth-of-type(1) .panel-title > div:nth-of-type(3) button')).toHaveLength(1);
                expect($form.find('.control.nestedCommentBox-control .ncb-body-region .panel-container:nth-of-type(1) .panel:nth-of-type(1) .panel-title > div:nth-of-type(3) button')).toHaveClass('show-comments-button');
            });
