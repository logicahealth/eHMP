        ...
        describe('A radio control', function() {
            ...
            describe("all disabled", function() {
                ...
                it("has all options disabled", function() {
                    expect($form.find('.radio-control input')).toHaveLength(3);
                    expect($form.find('.radio-control input')).toBeDisabled();
                });
            });
            describe("single disabled", function() {
                ...
                it("has one option disabled", function() {
                    var radioOptions = $form.find('.radio-control input');
            ...
            describe("basic with sr-only", function() {
                ...
                it("contains label with sr-only class", function() {
                    expect($form.find('.control p')).toHaveText('radio with sr-only label');
                    expect($form.find('.control p')).toHaveClass('sr-only');
                });
            });
