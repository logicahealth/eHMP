        ...
        describe('A tabs control', function() {
            ...
            describe('basic', function() {
                ...
                it('contains correct number of controls per tab', function() {
                    expect($form.find('.tab-content-container [id*="Example-Tab-1-tab-panel"] .control')).toHaveLength(2);
                    expect($form.find('.tab-content-container [id*="Example-Tab-2-tab-panel"] .control')).toHaveLength(1);
                    expect($form.find('.tab-content-container [id*="Example-Tab-3-tab-panel"] .control')).toHaveLength(2);
                });
                it('displays tab content when tab is clicked', function() {
                    ...
                    expect($form.find('.tab-content-container [id*="Example-Tab-1-tab-panel"]')).toHaveClass('active');
                    // click tab
