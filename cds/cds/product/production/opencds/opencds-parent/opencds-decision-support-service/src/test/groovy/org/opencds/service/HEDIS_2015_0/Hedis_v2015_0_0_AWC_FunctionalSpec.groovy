...
public class Hedis_v2015_0_0_AWC_FunctionalSpec extends Specification 
{
	...
	/* 0 : Num check: Missing DOB value  */
	private static final Map ASSERTIONS_EMPTY0001 = [reject:'']
    private static final Map MEASURES_EMPTY0001 = [C2626: [num: 0, denom: 0]]
...
*/
	...
	@Unroll
	def "test HEDIS AWC v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_AWC', version: '2015.0.0'],
...
//        assert results.measuresList.containsKey(entry.key)
