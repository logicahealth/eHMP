...
public class Hedis_v2015_0_0_CCS_FunctionalSpec extends Specification 
{
    ...
    private static final Map MEASURES_EMPTY0001 = [C2598: [num: 0, denom: 0]]
	...
	private static final Map ASSERTIONS_CCS0002 = [C2750: '', C2756: '', C31:'',C539:'',C54:'',C545:'']
	...
	private static final Map ASSERTIONS_CCS0008 = [C2750: '', C2756: '', C31:'', C539:'',C54:'',C545:'']
...
*/
	...
	@Unroll
	def "test HEDIS CCS v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_CCS', version: '2015.0.0'],
