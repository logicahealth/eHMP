...
public class Hedis_v2015_0_0_CHL_FunctionalSpec extends Specification 
{
    ...
    private static final Map MEASURES_EMPTY0001 = [C2601: [num: 0, denom: 0]]
	...
	private static final String CHL0009 = "src/test/resources/samples/hedis-chl/SampleCHL0009.xml" 
	//LOINC codes were removed from the sexual activity value sets
	private static final Map ASSERTIONS_CHL0009 = ['O.01':'']
	private static final Map MEASURES_CHL0009 = [C2601: [num: 0, denom: 0], C3372: [num: 0, denom: 0], C3373: [num: 0, denom: 0]]
	...
	private static final String CHL0015 = "src/test/resources/samples/hedis-chl/SampleCHL0015.xml" //Denom Not Met
	private static final Map ASSERTIONS_CHL0015 = ['O.01':'']
	private static final Map MEASURES_CHL0015  = [C2601: [num: 0, denom: 0], C3372: [num: 0, denom: 0], C3373: [num: 0, denom: 0]]

// TODO the following two tests fail, probably due to the change in the value sets. In HEDIS 2015,  
	//a person CANNOT qualify for sexual activity based on Pregnancy tests alone, because all the codes from pregnancy tests are also in sexual activity value set (see the 2015 HEDIS technical update...
	private static final String CHL0016 = "src/test/resources/samples/hedis-chl/SampleCHL0016.xml" //Denom Not Met 
	private static final Map ASSERTIONS_CHL0016 = [C1693:'', C2519:'', C2766:'', C2836:'', C3441:'', C31:  '', C544: '', C545:'']
	...
	private static final Map ASSERTIONS_CHL0017 = [C1693:'', C2519:'', C2766:'', C2836:'', C3441:'', C31:  '', C544: '', C545:'']
...
// TODO the following test fails, probably due to a missing or misnamed mapping for HEDIS-Sexual Activity (see the 2015 HEDIS technical update...
		private static final String CHL0024 = "src/test/resources/samples/hedis-chl/SampleCHL0024.xml" //Denom Not Met
		private static final Map ASSERTIONS_CHL0024 = [C1693:'', C2519:'', C2766:'', C2836:'', C3440:'', C31:  '', C544: '', C545:'']
		private static final Map MEASURES_CHL0024  = [C2601: [num: 0, denom: 0], C3372: [num: 0, denom: 0], C3373: [num: 0, denom: 0]]
...
OUTPUT
	...
	C3429 : 'Age',
	C3431 : 'CHL Table A Prescriptions to Identify Contraceptives Med',
	C3432 : 'Sexual Activity EncDx',
	C3433 : 'Sexual Activity Proc',
	C3434 : 'Sexual Activity Obs',
	C3435 : 'Pregnancy EncDx',
	C3436 : 'Pregnancy Test Proc',
	C3437 : 'Pregnancy Test Obs',
	C3438 : 'Pregnancy Test Proc Before CHL Table E Med',
	C3439 : 'Pregnancy Test Obs Before CHL Table E Med',
	C3440 : 'Pregnancy Test Obs Before Radiology Proc',
	C3441 : 'Pregnancy Test Proc Before Radiology Proc',
	C3442 : 'Chlamydia Test Proc',
	C3443 : 'Chlamydia Test Obs',
...
*/
	...
	@Unroll
	def "test HEDIS CHL v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_CHL', version: '2015.0.0'],
...
// TODO the following two tests fail, probably due to a missing or misnamed mapping for HEDIS-Sexual Activity (see the 2015 HEDIS technical update...
...
//	TODO the following test fails, probably due to a missing or misnamed mapping for HEDIS-Sexual Activity (see the 2015 HEDIS technical update...
		CHL0024 | ASSERTIONS_CHL0024| MEASURES_CHL0024
	}
}
