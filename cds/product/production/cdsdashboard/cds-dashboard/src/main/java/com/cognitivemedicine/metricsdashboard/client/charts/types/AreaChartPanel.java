...
/**
 * An area chart implementation
 * 
 * @author sschechter
 * 
 */
public class AreaChartPanel extends AbstractChartPanel<AreaChart, AreaChartOptions> {

  public AreaChartPanel(AreaChart chart, AreaChartOptions options) {
    super(chart, options);
  }
