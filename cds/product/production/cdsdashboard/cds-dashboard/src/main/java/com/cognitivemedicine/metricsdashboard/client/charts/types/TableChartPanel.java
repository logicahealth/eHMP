...
/**
 * A table implementation from the GWT chart library
 * 
 * @author sschechter
 * 
 */
public class TableChartPanel extends AbstractChartPanel<Table, TableOptions> {

  public TableChartPanel(Table table, TableOptions options) {
    super(table, options);
  }
