 ...
 */
public class DroolsLocal implements CDSEnginePlugInIFace {

	private static final Logger logger = LoggerFactory.getLogger(DroolsLocal.class);
	private final String type = "DroolsLocal";
