 ...
 */
public class DroolsRemote implements CDSEnginePlugInIFace {

	private static final Logger logger = LoggerFactory.getLogger(DroolsRemote.class);
	private final String type = "DroolsRemote";
	 ...
	 *
	 * @param rules
	 * @param data Based64 Encodded Blob
	 * @param callId
	 */
	...
	@Override
	public ResultBundle invokeRaw(List<Rule> rules, Object data,
		String callId, EngineInstanceStateManagementIFace eism) {
