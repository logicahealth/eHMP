 ...
 */
public class ResultBundle3 implements Serializable {

	private List<Result3> results;
	private StatusCode status;
	private List<FaultInfo> faultInfo;

	public ResultBundle3(){
		results = new LinkedList<Result3>();
	}
	...
	public List<Result3> getResults() {
        if (results == null) 
            results = new ArrayList<Result3>();
		return results;
	}

	public void setResults(List<Result3> results) {
