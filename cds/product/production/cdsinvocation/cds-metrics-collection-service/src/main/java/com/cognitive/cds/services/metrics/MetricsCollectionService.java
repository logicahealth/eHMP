...
import com.cognitive.cds.HealthCheck;
...
public class MetricsCollectionService implements MetricsCollectionServiceIface {
    ...
    public void setMongoDbDao(MongoDbDao mongoDbDao) {
        ...
        LOGGER.error("MetricsCollectionService.mongoDbDao: " + mongoDbDao);
    }
    ...
    public void setHealthCheck(HealthCheck healthCheck) {
        ...
        LOGGER.error("MetricsCollectionService.HealthCheck: " + healthCheck);
    }
    ...
    public String healthCheck() {
        LOGGER.error("MetricsCollectionService.HealthCheck: " + healthCheck);
        return healthCheck.healthCheck("MetricsCollectionService");
    }
