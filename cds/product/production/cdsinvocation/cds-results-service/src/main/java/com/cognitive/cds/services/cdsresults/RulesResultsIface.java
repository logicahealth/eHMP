...
/**
 * Invoking Rules for given patient
 * 
 ...
 */
@Path("/rest")
public interface RulesResultsIface {

    CDSResultBundle invokeRulesForPatient(InvocationRequest request, @javax.ws.rs.core.Context  MessageContext context);
    public String ping();
}
