...
public class Hedis_v2015_0_0_COL_FunctionalSpec extends Specification 
{
    ...
    private static final Map MEASURES_EMPTY0001 = [C2600: [num: 0, denom: 0]]
	
    private static final String COL0001 = "src/test/resources/samples/hedis-col/SampleCOL0001.xml" //Denom Not Met
	private static final Map ASSERTIONS_COL0001 = ["O.01":'']
	...
	private static final Map ASSERTIONS_COL0002 = ["O.01":'']
...
*/
	...
	@Unroll
	def "test HEDIS COL v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_COL', version: '2015.0.0'],
