...
public class Hedis_v2015_0_0_NCS_FunctionalSpec extends Specification 
{
    ...
    private static final Map MEASURES_EMPTY0001 = [C2599: [num: 0, denom: 0]]
...
*/
	...
	@Unroll
	def "test HEDIS NCS v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_NCS', version: '2015.0.0'],
