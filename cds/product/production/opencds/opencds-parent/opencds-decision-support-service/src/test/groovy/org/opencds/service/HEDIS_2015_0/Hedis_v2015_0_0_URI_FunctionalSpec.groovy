...
public class Hedis_v2015_0_0_URI_FunctionalSpec extends Specification 
{
    ...
    private static final Map MEASURES_EMPTY0001 = [C2605: [num: 0, denom: 0]]
	...
	private static final Map ASSERTIONS_URI0001 = [C1527:'', C3216:'', C539: '', C54:  '', C545: '', 'C2605: C3422: C3470' : '[Date]20110213115000']
	...
	private static final Map ASSERTIONS_URI0002 = [C1527:'', C3216:'', C539: '', C54:  '', C545: '', 'C2605: C3422: C3470' : '[Date]20110223115000']
	...
	private static final Map ASSERTIONS_URI0003 = [C3216:'', C54:  '', C545: '', 'C2605: C3422: C3470' : '[Date]20110123115000']
...
*/
	...
	@Unroll
	def "test HEDIS URI v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_URI', version: '2015.0.0'],
