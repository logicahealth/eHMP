...
public class Hedis_v2015_0_0_W15_FunctionalSpec extends Specification 
{
	private static final String EMPTY0001 = "src/test/resources/samples/hedis-w15/Empty0001.xml" //missing DOB
    private static final Map MEASURES_EMPTY0001 = [C3349: [num: 0, denom: 0]]
...
*/
	...
	@Unroll
	def "test HEDIS W15 v2015.0.0"() 
	{
		when:
		def input = new File(vmr).text
		def params = [
			kmEvaluationRequest:[scopingEntityId: 'edu.utah', businessId: 'HEDIS_W15', version: '2015.0.0'],
