...
default[:ehmp_provision][:crs][:aws][:ssh_username] = "ec2-user"
default[:ehmp_provision][:crs][:aws][:ssh_keyname] = "vagrantaws_c82a142d5205"
...
default[:ehmp_provision][:crs][:vagrant][:ip_address] = "10.2.2.211"
