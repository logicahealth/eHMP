...
default[:ehmp_provision][:jds][:aws][:ssh_username] = "ec2-user"
default[:ehmp_provision][:jds][:aws][:ssh_keyname] = "vagrantaws_c82a142d5205"
...
default[:ehmp_provision][:jds][:vagrant][:ip_address] = "10.2.2.110"
