...
You may use this secret_key to add items to a data bag during a create.
    ...
    knife data bag create --secret-file secret_key passwords USER

You may also use it when adding ITEMs from files,

    knife data bag create passwords
    knife data bag from file passwords data_bags/passwords/USER.json --secret-file secret_key
...
Without the secret_key, the contents are encrypted.
    ...
    knife data bag show passwords USER
    id:        USER
    password:  PW

Use the secret_key to view the contents.

    knife data bag show passwords USER --secret-file secret_key
    id:        USER
    password:  PW
