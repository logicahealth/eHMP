...
<project>
  ...
  <scm class="hudson.plugins.git.GitSCM" plugin="git@1.5.0">
    ...
    <includedRegions>project_cookbooks/adk/.*</includedRegions>
    <scmName></scmName>
  </scm>
...
export SLAVE_NAME=vpc_slave_test_slave_setup
/opt/chefdk/embedded/bin/rake slave[converge,vpc_slave_test_slave_setup]
</command>
    </hudson.tasks.Shell>
    <hudson.tasks.Shell>
      <command>#!/usr/bin/env bash
export SLAVE_NAME=vpc_slave_test_slave_setup
/opt/chefdk/embedded/bin/rake slave[destroy,vpc_slave_test_slave_setup]</command>
    </hudson.tasks.Shell>
  </builders>
  <publishers/>
  <buildWrappers>
