...
#List of slaves we want to only have 1 executor
#Update/remove/add list entries as needed.
[
"vpc_slave_team_test_patient-record-sandbox",
"vpc_slave_team_test_sdk-sandbox",
"vpc_slave_team_test_application-sandbox",
"vpc_slave_team_test_platform-sandbox"
].each { |name| system "SLAVE_EXECUTORS=1 rake slave[converge,#{name}]"}
</command>
    </hudson.tasks.Shell>
  </builders>
  <publishers/>
