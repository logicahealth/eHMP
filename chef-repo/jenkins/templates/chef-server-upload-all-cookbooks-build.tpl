...
<project>
  ...
  <scm class="hudson.plugins.git.GitSCM" plugin="git@1.5.0">
    ...
    <includedRegions>project_cookbooks/.*
wrapper_cookbooks/.*
third_party_cookbooks/.*
machine_cookbooks/.*</includedRegions>
    <scmName></scmName>
  </scm>
  ...
  <builders>
    <hudson.tasks.Shell>
      <command>/opt/chefdk/embedded/bin/rake upload_all_cookbooks[$gitBranch-last-upload]</command>
    </hudson.tasks.Shell>
  </builders>
  <publishers>
  <hudson.plugins.git.GitPublisher plugin="git@2.4.4">
      ...
      <tagsToPush>
        <hudson.plugins.git.GitPublisher_-TagToPush>
          ...
          <tagName>$gitBranch-last-upload</tagName>
