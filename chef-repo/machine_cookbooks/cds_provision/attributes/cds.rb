...
default[:cds_provision][:cds][:aws][:subnet] = "DNS"
default[:cds_provision][:cds][:aws][:ssh_username] = "USER    "
default[:cds_provision][:cds][:aws][:ssh_keyname] = "SSH KEYNAME"
...
default[:cds_provision][:cds][:vagrant][:ip_address] = "IP       "
