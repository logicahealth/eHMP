...
default[:cds_provision][:cdsdashboard][:aws][:instance_type] = ENV["CDSDASHBOARD_INSTANCE_TYPE"] || "m3.medium"
...
default[:cds_provision][:cdsdashboard][:vagrant][:ip_address] = "172.16.2.48"
