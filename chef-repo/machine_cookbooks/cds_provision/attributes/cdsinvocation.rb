...
default[:cds_provision][:cdsinvocation][:aws][:instance_type] = ENV["CDSINVOCATION_INSTANCE_TYPE"] || "m3.medium"
default[:cds_provision][:cdsinvocation][:aws][:subnet] = "subnet-213b2256"
default[:cds_provision][:cdsinvocation][:aws][:ssh_username] = "PW      "
...
default[:cds_provision][:cdsinvocation][:vagrant][:ip_address] = "172.16.2.49"
