...
default[:'chef-repo_provision'][:jenkins][:aws][:subnet] = "DNS"
default[:'chef-repo_provision'][:jenkins][:aws][:ssh_username] = "USER    "
default[:'chef-repo_provision'][:jenkins][:aws][:ssh_keyname] = "SSH KEYNAME"
...
default[:'chef-repo_provision'][:jenkins][:vagrant][:ip_address] = "IP        "
