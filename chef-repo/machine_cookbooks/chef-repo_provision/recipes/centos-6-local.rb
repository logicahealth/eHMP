...
vagrant_box 'opscode-centos-6.5-users' do
  url "#{node[:common][:nexus_url]}/nexus/content/repositories/filerepo/third-party/program/opscode/centos/6.5-users/centos-6.5-users.box"
end

osx_opts = {}
osx_opts[:box_name] = 'opscode-centos-6.5-users'
osx_opts[:network] = {
