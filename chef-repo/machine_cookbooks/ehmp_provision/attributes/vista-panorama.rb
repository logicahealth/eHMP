...
default[:ehmp_provision][:'vista-panorama'][:aws][:instance_type] = ENV["VISTA_PANORAMA_INSTANCE_TYPE"] || "m3.medium"
default[:ehmp_provision][:'vista-panorama'][:aws][:subnet] = "subnet-213b2256"
default[:ehmp_provision][:'vista-panorama'][:aws][:ssh_username] = "PW      "
