...
default[:ehmp_provision][:'vista-panorama'][:aws][:subnet] = "DNS"
default[:ehmp_provision][:'vista-panorama'][:aws][:ssh_username] = "USER    "
default[:ehmp_provision][:'vista-panorama'][:aws][:ssh_keyname] = "SSH KEYNAME"
