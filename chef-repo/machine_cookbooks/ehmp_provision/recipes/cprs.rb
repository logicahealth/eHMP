...
windows_box_url = "#{node[:common][:nexus_url]}/nexus/content/repositories/ehmp/filerepo/third-party/program/vagrant/basebox/windows7pro-base/2.6/windows7pro-base-2.6.box"
box_timeout = 3600
...
with_chef_server 'https://chef.vaftl.us/organizations/vistacore',
...
machine_opts = {
  ...
  :convergence_options => {
    :install_msi_url => "#{node[:common][:nexus_url]}/nexus/content/repositories/ehmp/filerepo/third-party/program/chef/chef-client/12.3.0/chef-client-12.3.0.msi"
  }
}
