...
windows_box = "windows7pro-base-2.7"
windows_box_url = "#{node[:common][:nexus_url]}/nexus/content/repositories/filerepo/third-party/program/vagrant/basebox/windows7pro-base/2.7/windows7pro-base-2.7.box"
box_timeout = 3600
