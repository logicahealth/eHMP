...
machine_ident = ENV['JDS_PRIME_SERVER_IDENT'] || "jds_prime_server"
...
r_list << "role[jds_prime_server]"
r_list << "recipe[jds::jds_prime_server@#{ehmp_deps["jds"]}]"
...
machine machine_name do
  ...
  attributes(
    ...
    jds: {
      jds_database_location: "/usr/jdsdbs/vprops"
    },
    beats: {
