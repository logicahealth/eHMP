...
default[:jbpm][:install][:patch13] = "#{node[:nexus_url]}/nexus/service/local/repositories/filerepo/content/third-party/project/jboss/jboss-eap/6.4.13/jboss-eap-6.4.13-patch.zip"
