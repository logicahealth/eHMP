-------------------------------------------------------------------------------
--  This DDL script is for reference only. It is not used in any script
--  This was obtained from Red Hat jboss-brms-bpmsuite-6.4-supplementary-tools
--  It creates JBPM tables, sequences, and indexes.
-------------------------------------------------------------------------------
