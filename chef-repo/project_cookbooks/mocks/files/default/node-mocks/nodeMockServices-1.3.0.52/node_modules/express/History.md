 ...
 * proper proxy trust with `app.set('trust proxy', trust)`
   ...
   - `app.set('trust proxy', 'IPADDRES')` trust single IP
   - `app.set('trust proxy', 'IPADDRES/16')` trust subnet
   - `app.set('trust proxy', 'IPADDRES, IPADDRES')` trust list
...
==================
  ...
  * Added PW     to session middleware used in examples and generated app
...
==================
  ...
  * Added PW     to generated app `session()` call
