...
vista_mumps_block "Update Panorama Institution to point to correct domain" do
  ...
  command [
    'S XUMF=1',
    'K FDA,IENS,ERR',
    'S IENS=$$FIND1^DIC(4,,"QMX",500)_","',
    'S FDA(4,IENS,.01)="CAMP MASTER"',
    'S FDA(4,IENS,60)=$$FIND1^DIC(4.2,,"X","PANORAMA.VISTACORE.US")',
    'D FILE^DIE(,"FDA","ERR")',
    'I $D(ERR) ZWRITE ERR',
...
vista_mumps_block "Add New Kodak Institution" do
  ...
  command [
    'S XUMF=1',
    'K FDA,IENA,ERR,DA,DIK',
    %Q|S DIK="^DIC(4,",DA=#{vista_station['kodak']} D ^DIK|,
...
vista_mumps_block "Add New VHIC Institution" do
  ...
  command [
    ...
    'K FDA,IENA,ERR,DA,DIK',
    'S FDA(4,"+1,",.01)="VHIC"',
    %Q|S DIK="^DIC(4,",DA=#{vista_station['vhic']} D ^DIK|,
    'S FDA(4,"+1,",60)=455',
...
vista_mumps_block "Add new HDR domains" do
  ...
  command [
    'S XUMF=1',
    'K FDA,DMNIENA,ERR,DA,DIK',
    %Q|S DIK="^DIC(4,",DA=#{vista_station['chantilly']} D ^DIK|,
    %Q|S DIK="^DIC(4,",DA=#{vista_station['sandiego']} D ^DIK|,
    %Q|S DIK="^DIC(4,",DA=#{vista_station['tampa']} D ^DIK|,
