...
node.default["workstation"]["java_osx"]["url"] = "#{node[:nexus_url]}/nexus/content/repositories/filerepo/third-party/project/oracle/jdk/8u121-macosx/jdk-8u121-macosx-x64.dmg"
