...
#### Attribute Parameters
- :ipv4_address: Name attribute. Required. IPv4 address, e.g. 'IP_ADDRESS'
...
Create a TCP/IP printer port named 'IP_IP_ADDRESS' with all defaults
```ruby
windows_printer_port 'IP_ADDRESS' do
end
```
...
- :ipv4_address: Printer IPv4 address, e.g. 'IP_ADDRESS'. You don't have to be able to ping the IP addresss to set it. Required.
