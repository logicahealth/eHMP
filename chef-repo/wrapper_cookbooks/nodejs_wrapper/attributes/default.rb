...
default[:nodejs][:binary][:url] = "http://nexus.osehra.org:8081/nexus/content/repositories/filerepo/third-party/project/nodejs/node/#{node[:nodejs][:version]}/node-#{node[:nodejs][:version]}-x64.tgz"
