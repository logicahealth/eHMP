...
default[:nodejs][:binary][:url] = "https://nexus.osehra.org:8444/nexus/content/repositories/filerepo/third-party/project/nodejs/node/#{node[:nodejs][:version]}/node-#{node[:nodejs][:version]}-x64.tgz"
