...
default[:nodejs][:binary][:url] = "#{node[:nexus_url]}/nexus/content/repositories/ehmp/filerepo/third-party/project/nodejs/node/v0.10.40/node-v0.10.40-linux-x64.tar.gz"
