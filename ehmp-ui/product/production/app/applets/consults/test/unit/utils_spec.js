...
define([
    ...
    'require',
    'underscore'
], function(Stubs, $, Backbone, Marionette, moment, JasmineJquery, ConsultsApplet, Util, require, _) {
    describe('Load ActivitiesModel', function() {

        describe('Setting up consults test', function() {
            var ActivitiesModel;
            ...
            describe('Test Consult applet', function() {
                ...
                var testRegion;
                var getMockActivitiesModel = function(urgancyCode) {
