define([
    ...
    var SearchModel = Backbone.Model.extend({
        ...
        initialize: function() {
            ...
            this.listenToOnce(ADK.Messaging.getChannel('patient-selection-wards'), 'patientSearchTray.show', this.executeSearch);
        },
    ...
    var WardSearchForm = ADK.UI.Form.extend({
        ...
        onSearch: function() {
            ADK.Messaging.getChannel('patient-selection-wards').trigger('execute-search', this.model);
        }
    });
    ...
    var WardFilterView = Backbone.Marionette.ItemView.extend({
        ...
        onBeforeShow: function() {
            this._regionManager.get('searchRegion').show(new WardSearchForm({
