define([
    ...
    'jquery',
    'handlebars',
    'app/applets/requests/toolbar/toolbarView',
    'app/applets/requests/utils',
    'app/applets/requests/config'
    ...
    var AppletLayoutView = ADK.AppletViews.GridView.extend({
        ...
        initialize: function(options) {
            ...
            var ContextSpecificToolbar = ToolbarView.extend({
                fields: Util.getToolbarFormFields('onlyShowFlaggedRequests', this.columnsViewType, ADK.WorkspaceContextRepository.currentContextId, 'Requests')
            });
            var dataGridOptions = {
                body: body,
                tileOptions: {
