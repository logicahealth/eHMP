define([
    ...
    var flagColumn = {
        ...
        label: 'Flag',
        flexWidth: 'flex-width-none pixel-width-40',
        cell: Backgrid.HandlebarsCell.extend({
            className: 'handlebars-cell flex-width-none pixel-width-40',
            render: function() {
    ...
    var patientViewSummaryColumns = [urgencyColumn, flagColumn, activityNameColumn, taskStateColumn];
    var staffViewSummaryColumns = [urgencyColumn, patientNameColumn, flagColumn, activityNameColumn];
    var patientViewExpandedColumns = [urgencyColumn, flagColumn, activityNameColumn, taskStateColumn, intendedForColumn, assignedFacilityColumn, createdByColumn, createdAtColumn, createdOnColumn, modeColumn];
    var staffViewExpandedColumns = [urgencyColumn, patientNameColumn, flagColumn, activityNameColumn, taskStateColumn, intendedForColumn, assignedFacilityColumn, createdByColumn, createdAtColumn, createdOnColumn, modeColumn];
