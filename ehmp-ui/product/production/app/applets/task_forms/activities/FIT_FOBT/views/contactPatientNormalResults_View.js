...
function(Backbone, Marionette, _, Handlebars, FollowUpTemplate) {
    ...
    var normalResultsModel = new NormalResultsModel();

    var NormalResultsForm = ADK.UI.Form.extend({
        _super: ADK.UI.Form.prototype,
        model: normalResultsModel,
        fields: [{
            control: 'checkbox',
            ...
            control: 'textarea',
            name: 'out_patient_notes',
            label: 'Notes',
            placeholder: 'Notes',
            rows: 15
        }, {
            control: 'checkbox',
            name: 'out_patient_follow_up',
    ...
    return Backbone.Marionette.LayoutView.extend({
        ...
        initialize: function(options) {
            ...
            this.formModel = normalResultsModel;
            normalResultsModel.clear();
        ...
        onShow: function() {
            // Give NormalResultsForm access to the task model
            this.form_elements.show(new NormalResultsForm({
