define([
    ...
    'app/resources/picklist/video_visits/resources'
], function(Demo, Allergies, Lab_Orders, Immunizations, Encounters, Vitals, Notes, Problems, Locations, Team_Management, VideoVisits) {
    'use strict';
