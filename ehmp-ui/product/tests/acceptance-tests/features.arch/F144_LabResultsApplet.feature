...
Scenario: Numeric Lab Results Applet - Ensure no data flickering on initial load.
  Given user searches for and selects "Five,Patient"
  Then Cover Sheet is active
  Then there is no brief display of data in the "Numeric Lab Results applet"
  Then no results should be found in the "Numeric Lab Results applet"

@f144_numeric_lab_results_flickering @US2649 @TA8610b
Scenario: Numeric Lab Results Applet - Ensure no data flickering on date criteria change.
  Given user searches for and selects "Five,Patient"
  Then Cover Sheet is active
...
@f144_numeric_lab_results_flickering @US2649 @TA8610c
Scenario: Numeric Lab Results Applet - Ensure no data flickering on single page initial load.
  Given user searches for and selects "Five,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  Then there is no brief display of data in the "Numeric Lab Results applet"
...
@f144_numeric_lab_results_flickering @US2649 @TA8610d
Scenario: Numeric Lab Results Applet - Ensure no data flickering on single page date criteria change.
  Given user searches for and selects "Five,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  And the user clicks the date control "1yr" in the "Numeric Lab Results applet"
  And the user clicks the control "Filter Toggle" in the "Numeric Lab Results applet"
  Then there is no brief display of data in the "Numeric Lab Results applet"
  Then no results should be found in the "Numeric Lab Results applet"

@f144_numeric_lab_results_flickering @US2649 @TA8610e
Scenario: Numeric Lab Results Applet - Ensure no data flickering when text filtering is used.
...
@f144_numeric_lab_results_flickering @US2649 @TA8610f
Scenario: Numeric Lab Results Applet - Ensure no data flickering when text filtering is used on single page view.
  Given user searches for and selects "Eight,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  And the user inputs "LDL" in the "Text Filter" control in the "Numeric Lab Results applet"
  And the user clicks the date control "2yr" in the "Numeric Lab Results applet"
  #Then there is no brief display of data in the "Numeric Lab Results applet"
  Then no results should be found in the "Numeric Lab Results applet"

@f144_numeric_lab_results_table_returns_anatomic_pathology_results @DE377a @moved_to_rdk
Scenario: Numeric Lab Results Applet - Ensure anatomic pathology results are displayed
  Given user searches for and selects "Onehundredten,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  Then the Numeric Lab Results Applet table displays No Records Found
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  Then the "Numeric Lab Results Applet" table contains 25 rows
  And the user inputs "patho" in the "Text Filter" control in the "Numeric Lab Results applet"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  Then the "Numeric Lab Results Applet" table contains 4 rows
  And the "Numeric Lab Results Applet" table contains rows
    | Date             | Lab Test                                | Flag | Result      | Unit | Ref Range | Facility  |
...
@f144_numeric_lab_results_table_returns_microbiology_results @DE377b @DE1261 @moved_to_rdk
Scenario: Numeric Lab Results Applet - Ensure microbiology results are displayed
  Given user searches for and selects "Zzzretfourthirtytwo,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  When the applet displays numeric lab results
  And the user inputs "micro" in the "Text Filter" control in the "Numeric Lab Results applet"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  Then the "Numeric Lab Results Applet" table contains 1 rows
  And the "Numeric Lab Results Applet" table contains rows
    | Date             | Lab Test                   | Flag | Result      | Unit | Ref Range | Facility  |
...
@f144_3b_numeric_lab_results_base_applet_single_page @US2033 @TA5445 @DE1251 @reworked_in_firefox
Scenario: View ALL Lab result on Expand View
  ...
  Then the Numeric Lab Results single page is displayed
  And the numeric lab results applet title is "LAB RESULTS"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  ...
  Then the "Numeric Lab Results Applet" table contains 373 rows

@f144_filtering_LOINC_codes_in_numeric_lab_results_applet @S5709 @reworked_in_firefox
Scenario: Numeric Lab Results Applet - Ensure user can filter by the LOINC code
  Given user searches for and selects "Eight,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  When the applet displays numeric lab results
  And the user inputs "736-9" in the "Text Filter" control in the "Numeric Lab Results applet"
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  Then the "Numeric Lab Results Applet" table contains 1 rows
  And the "Numeric Lab Results Applet" table contains rows
    | Date               | Lab Test                                                               | Flag | Result | Unit | Ref Range | Facility  |
...
@f144_numeric_lab_results_panel_grouping_by_facility @DE250 @DE1259 @reworked_in_firefox
Scenario: Numeric Lab Results Applet - Ensure panels are not grouped together with different facilities.
  Given user searches for and selects "Eight,Patient"
  Then Cover Sheet is active
  When the user clicks the control "Expand View" in the "Numeric Lab Results applet"
  #Then the Numeric Lab Results Applet table displays No Records Found
  ...
  When the user clicks the date control "All" in the "Numeric Lab Results applet"
  Then the "Numeric Lab Results Applet" table contains 14 rows
  #And the "Numeric Lab Results Applet" table contains rows
...
@f144_3_numeric_lab_results_base_applet_single_page @US2033 @TA5445a @vimm_observed @vimm @reworked_in_firefox
Scenario: View Numeric Lab Results Base Applet Single Page by clicking on Expand View
  Given user searches for and selects "Eight,Patient"
  Then Cover Sheet is active
