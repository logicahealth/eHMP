...
@f144_numeric_lab_results_text_filtering_lab_type @US2552 @TA7994a @triage @DE1226 @reworked_in_firefox
Scenario: Numeric Lab Results Applet - Filtering by Lab Type inside the panel and view VistA results
  Given the user is viewing the expanded "Numeric Lab Results" applet
  When the user inputs "a1c" in the "Text Filter" control in the "Numeric Lab Results applet"
...
@f144_numeric_lab_results_text_filtering_result @US2552 @TA7994c @triage @DE1226 @reworked_in_firefox
