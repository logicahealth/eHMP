...
Scenario: Encounters Applet Gist - quick view of admissions
  ...
  And quick view table with title "Recent Admissions" appears
  ...
  And user hovers over and selects the right side of the "Admissions" tile
...
Scenario: Encounters Applet Gist - quick view of a particular Diagnosis 
  ...
  And user clicks on the "Right" hand side of the "Diagnosis" "OBSERVATION"
  And the "Encounters Gist Quick View - Diagnosis" table contains headers
...
# When user clicks on the "Right" hand side of the "Diagnosis" "OBSERVATION"
  And the user expands "Admissions" in Encounters Gist Applet
...
Scenario: Encounters Applet Gist - quick view of a particular admission thro' multi option menu
  ...
  When the user expands "Admissions" in Encounters Gist Applet
  And user clicks on the "Left" hand side of the "Diagnosis" "OBSERVATION"
  And a Menu appears on the Encounters Gist
  And user select the menu "Quick View Button" in Encounters Gist
  And the "Encounters Gist Quick View - Diagnosis" table contains headers
    | Date	| Location | Facility |
  And the Encounters Gist Quick View - "Admissions" Type table contains rows
