...
@f144_numeric_lab_results_modal_apply_enabled @US2326 @TA6661b @DE284 @reworked_in_firefox
Scenario: Custom filters should NOT retain their values.
  ...
  Then the "From Date" input should have the value "" in the "Numeric Lab Results modal"
  And the "To Date" input should have the value "" in the "Numeric Lab Results modal"
  And the Custom date field "Apply" button should be "disabled" in the "Numeric Lab Results modal"

@f144_numeric_lab_results_modal_apply_enabled @US2326 @TA6661a @reworked_in_firefox
