...
@f144_timeline_immunization_modal_details @data_specific
Scenario: Users will be able to view modal popup for event Discharge
  Given user is logged into eHMP-UI
...
@f144_timeline_surgery_modal_details @data_specific @DE2907 @debug @DE3334
Scenario: Users will be able to view modal popup for event Surgery
  ...
  Then the modal is displayed
  And the modal's title is "biospy Details"
...
@f144_timeline_procedure_modal_details @data_specific @debug @DE3334
...
@f144_timeline_lab_modal_details @data_specific
