@f144_vitals @vitals_applet @US2800    @DE6991 @DE6976 @reg4
...
Scenario: User views vitals coversheet to view data
  ...
  And the Vitals Summary view contain 10 items 
...
Scenario: User uses the vitals expanded view to filter
  ...
  And the user filters the Vitals Applet by text "BMI"
  Then the vitals table only diplays rows including text "BMI"
