@f662_pob_access_control_write_back  @DE4326 @DE4560 @reg3
...
Scenario: Inactive user cann't login
  When POB user is logged into EHMP-UI with facility as  "PANORAMA" accesscode as  "REDACTED" verifycode as  "REDACTED"
