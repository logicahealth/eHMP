class PobClinicsSearch < SitePrism::Page
  ...
  # *****************  All_Field_Elements  ******************* #
  element :fld_clinics_location, "li.sidebar.open [x-is-labelledby='select2-clinicLocation-container']"
  element :fld_clinics_from_date, "#fromDate"
  element :fld_clinics_to_date, "#toDate"
  ...
  element :ddl_clinics_location_results, "#select2-clinicLocation-results"
