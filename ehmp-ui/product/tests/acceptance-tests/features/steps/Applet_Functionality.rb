class Navigation < AccessBrowserV2
  ...
  def initialize
    ...
    add_action(CucumberLabel.new("Visit"), ClickAction.new, AccessHtmlElement.new(:id, "urn-va-visit-9E7A-3-11417"))
...
class CountElements < AccessBrowserV2
  ...
  def initialize
    ...
    @@vitals_cover_count = AccessHtmlElement.new(:xpath, "//*[@id='grid-panel-vitals']/div[3]/div/div[1]/div/table/tbody/tr")
