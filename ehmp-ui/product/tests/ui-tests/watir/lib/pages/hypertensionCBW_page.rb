...
class HypertensionPage
  ...
  div(:lab_result_applet, css: '[data-appletid=numeric_lab_results_grid]')
  div(:clinical_reminders_applet, css: '[data-appletid=cds_advice]')
  div(:timeline_applet, css: '[data-appletid=newsfeed]')
  div(:med_review_applet, css: '[data-appletid=medication_review]')
  div(:appointment_applet, css: '[data-appletid=appointments]')
  div(:documents_applet, css: '[data-appletid=documents]')
  button(:lab_result_filter_button, id: 'grid-filter-button-htcbw-numeric_lab_results_grid-1')
  ...
  # |Pre-procedure| == grid-filter-ppcbw-numeric_lab_results_grid-1 #grid-filter-ppcbw-numeric_lab_results_grid-1 span.udaf-tag span
end
