...
# debugged this test because it randomly fails and the cucumber test is still passing consistently
describe 'Feature No. F117: f117_key_capabilities_spec.rb', debug: true do
  ...
  context 'DE1151: When user is logged in and choose patient with one confirmation' do
    ...
    it 'Search for a Patient on My Site' do
      ...
      overview.oVSsn_element.when_visible
