 ...
 *         &lt;element name="vitalModifiers" type="{http://webservice.vds.med.va.gov/}vitalModifier" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "vitals", namespace = "http://webservice.vds.med.va.gov/", propOrder = {
    "comments",
    "dateTimeTaken",
    "qualifiers",
    "rate",
