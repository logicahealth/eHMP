 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://webservice.vds.med.va.gov/}patient">
 *       &lt;sequence>
 ...
 *         &lt;element name="emergencyContact" type="{http://webservice.vds.med.va.gov/}person" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="ethnicity" type="{http://webservice.vds.med.va.gov/}code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="flags" type="{http://webservice.vds.med.va.gov/}flag" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="nextOfKin" type="{http://webservice.vds.med.va.gov/}person" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="pcAssigned" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="pcProvider" type="{http://webservice.vds.med.va.gov/}provider" minOccurs="0"/>
 ...
 *         &lt;element name="race" type="{http://webservice.vds.med.va.gov/}code" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "patientDemographics", namespace = "http://webservice.vds.med.va.gov/", propOrder = {
    "address1",
    "address2",
    "admissionDate",
    "admissionId",
