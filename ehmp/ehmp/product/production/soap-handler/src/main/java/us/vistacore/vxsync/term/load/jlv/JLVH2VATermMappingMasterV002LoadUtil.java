...
public class JLVH2VATermMappingMasterV002LoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS vatermmastermapping_v002 (rowId INT PRIMARY KEY, " + 
					                                                                                   ...
					                                                                                   "optCode VARCHAR(1))";
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS VATERMMASTERMAPPING_V002_SOURCECODE_IDX on VATERMMASTERMAPPING_V002(SOURCECODE)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS VATERMMASTERMAPPING_V002_TARGETCODE_IDX on VATERMMASTERMAPPING_V002(TARGETCODE)";
