...
function JdsClient(setLog, setConfig) {
    if (!(this instanceof JdsClient)) {
        return new JdsClient(setLog, setConfig);
    }
    this.log = setLog;
...
//-----------------------------------------------------------------------------------------
// Retrieve the operational data object by site and clinic.
//
// _options: Environment data
// site: The site that filters the operational data item being retrieved.
// clinic: The clinic that filters the operational data item being retrieved.
// callback: The handler to call when this request is completed.
// Returns  (through call back): the Operational data item.
//-----------------------------------------------------------------------------------------
...
//     'getOperationalDataBySiteAndClinic' : JdsClient.prototype.getOperationalDataBySiteAndClinic,
