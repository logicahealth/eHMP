...
function fetchMvi1305FileName(lastName, firstName, dob, ssn) {
    ...
    } else if (ssn === '432233234') {
        return 'Not Found 43215679';
    ...
    } else if ((lastName === 'JONES') && (firstName === 'FRED')) {
        return 'Multi Record DoDOnly 10 Results';
    ...
    } else if ((lastName === 'EDIPIONLY') && (firstName === 'PATIENT')) {
        return 'Single Record Patient EDIPIOnly';
    } else if ((lastName === 'EDIPIONLY') && (dob === '19671011')) {
        return 'Single Record Patient EDIPIOnly';
