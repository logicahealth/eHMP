...
function fetchVhicData(req, res) {
    ...
    req.on('data', function(data) {
        ...
        var namespace = { soap: 'http://www.w3.org/2003/05/soap-envelope', car: 'http://cardpictureservice.vic.va.insigniatechnology.com/'};

        //Define the path to the getVeteranPictures message element.
        var pathGetVeteranPictures = '//soap:Envelope/soap:Body/car:getVeteranPictures';
        ...
        if (getVeteranPicturesCritiera !== undefined) {
            ...
            veteranCardId = getElement(xmlDoc, pathGetVeteranPictures + '/arg0/cardIds', namespace);
