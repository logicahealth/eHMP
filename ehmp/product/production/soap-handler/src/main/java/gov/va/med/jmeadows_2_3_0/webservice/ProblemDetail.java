 ...
 *   &lt;complexContent>
 *     &lt;extension base="{http://webservice.vds.domain.ext/}problem">
 *       &lt;sequence>
 ...
 *         &lt;element name="notes" type="{http://webservice.vds.domain.ext/}problemNote" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "problemDetail", namespace = "http://webservice.vds.domain.ext/", propOrder = {
    "detailText",
    "enteredBy",
    "enteredDate",
    "notes",
