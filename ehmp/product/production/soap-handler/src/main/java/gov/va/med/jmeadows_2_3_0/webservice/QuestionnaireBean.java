 ...
 *         &lt;element name="responseComments" type="{http://webservice.vds.med.va.gov/}questionnaireResponseComments" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="responseDate" type="{http://www.w3.org/2001/XMLSchema}dateTime" minOccurs="0"/>
 *         &lt;element name="responses" type="{http://webservice.vds.med.va.gov/}questionnaireDetails" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "questionnaireBean", namespace = "http://webservice.vds.med.va.gov/", propOrder = {
    "comments",
    "enteredBy",
    "enteredDate",
    "name",
