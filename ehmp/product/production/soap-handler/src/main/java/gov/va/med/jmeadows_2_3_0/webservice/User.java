 ...
 *         &lt;element name="hostSite" type="{http://webservice.vds.med.DNS   /}site" minOccurs="0"/>
 *         &lt;element name="janusGUIConfig" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
 *         &lt;element name="janusPermissions" type="{http://webservice.vds.med.DNS   /}janusPermission" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "user", namespace = "http://webservice.vds.med.DNS   /", propOrder = {
    "agency",
    "bseToken",
    "dob",
    "dmisId",
