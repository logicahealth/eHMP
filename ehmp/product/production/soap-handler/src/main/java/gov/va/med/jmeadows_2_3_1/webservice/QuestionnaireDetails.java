 ...
 *       &lt;sequence>
 *         &lt;element name="answers" type="{http://webservice.vds.med.DNS   /}questionnaireDetailAnswers" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="choices" type="{http://webservice.vds.med.DNS   /}questionnaireDetailChoices" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="comments" type="{http://webservice.vds.med.DNS   /}questionnaireDetailComments" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "questionnaireDetails", namespace = "http://webservice.vds.med.DNS   /", propOrder = {
    "answers",
    "choices",
    "comments",
    "question",
