 ...
 *         &lt;element name="insuranceInfo" type="{http://webservice.vds.domain.ext/}insuranceBean" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "referralBean", namespace = "http://webservice.vds.domain.ext/", propOrder = {
    "authorizationNumber",
    "clinic",
    "fromDate",
    "insuranceInfo",
