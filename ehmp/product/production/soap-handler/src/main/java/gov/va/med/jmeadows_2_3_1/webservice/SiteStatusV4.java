 ...
 *         &lt;element name="partner" type="{http://webservice.bhie.med.DNS   /}partnerV4" minOccurs="0"/>
...
@XmlType(name = "siteStatusV4", namespace = "http://webservice.bhie.med.DNS   /", propOrder = {
    "expectedCount",
    "partner",
    "partnerStatus",
    "receivedCount"
