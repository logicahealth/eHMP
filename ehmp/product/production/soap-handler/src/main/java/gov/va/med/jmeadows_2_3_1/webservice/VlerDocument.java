 ...
 *       &lt;sequence>
 *         &lt;element name="authorList" type="{http://webservice.vds.domain.ext/}author" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "vlerDocument", namespace = "http://webservice.vds.domain.ext/", propOrder = {
    "authorList",
    "creationTime",
    "document",
    "documentUniqueId",
