 ...
 *         &lt;element name="comments" type="{http://webservice.vds.med.DNS   /}comment" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="drugClasses" type="{http://webservice.vds.med.DNS   /}code" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;element name="drugIngredients" type="{http://webservice.vds.med.DNS   /}code" maxOccurs="unbounded" minOccurs="0"/>
 ...
 *         &lt;element name="reactions" type="{http://webservice.vds.med.DNS   /}code" maxOccurs="unbounded" minOccurs="0"/>
...
@XmlType(name = "allergy", namespace = "http://webservice.vds.med.DNS   /", propOrder = {
    "allergyId",
    "allergyName",
    "comment",
    "comments",
