package us.vistacore.vxsync.dod.jmeadows_2_3_3_0_2;

import com.codahale.metrics.annotation.Timed;
import gov.va.med.jmeadows_2_3_3_0_2.webservice.*;
...
import static us.vistacore.vxsync.dod.JMeadowsVersion.V_2_3_3_0_2;

@Path("/dod")
public class JMeadowsSoapHandlerImpl implements JMeadowsSoapHandler {

    private static final JMeadowsVersion JMEADOWS_VERSION = V_2_3_3_0_2;
...
/*
    ...
    public String getJMeadowsDemographics(@QueryParam("edipi") String edipi) {
        try {
            ...
            //set PDWS demographics CDR event ID to the edipi
            for(PatientDemographics demo : oaDemographicsResults) {
                if (demo.getSite() != null) {
                    if ("PDWS".equalsIgnoreCase(demo.getSite().getName())) {
                        demo.setCdrEventId(edipi);
                    }
                }
            }
