...
public class JLVH2DodLabsLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS DOD_LABS_DODNCID_IDX on DOD_LABS(DODNCID)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS DOD_LABS_LOINC_IDX on DOD_LABS(LOINC)";
