...
public class JLVH2DodMedicationsLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS dod_medications (id INT PRIMARY KEY, " + 
			                                                                                   ...
			                                                                                   "mmmName VARCHAR(500)," +
			                                                                                   "rxnorm VARCHAR(20))";
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS DOD_MEDICATIONS_DODNCID_IDX on DOD_MEDICATIONS(DODNCID)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS DOD_MEDICATIONS_RXNORM_IDX on DOD_MEDICATIONS(RXNORM)";
