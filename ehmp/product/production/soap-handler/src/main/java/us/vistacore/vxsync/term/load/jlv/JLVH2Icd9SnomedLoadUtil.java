...
public class JLVH2Icd9SnomedLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS icd9_snomed (id INT PRIMARY KEY, " + 
		                                                                                   ...
		                                                                                   "inCore INT)";
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS ICD9_SNOMED_ICDCODE_IDX on ICD9_SNOMED(ICDCODE)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS ICD9_SNOMED_SNOMEDCID_IDX on ICD9_SNOMED(SNOMEDCID)";
