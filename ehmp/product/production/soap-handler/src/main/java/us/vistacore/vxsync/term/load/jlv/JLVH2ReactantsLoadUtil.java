...
public class JLVH2ReactantsLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS REACTANTS_UMLSCODE_IDX on REACTANTS(UMLSCODE)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS REACTANTS_VUID_IDX on REACTANTS(VUID)";
