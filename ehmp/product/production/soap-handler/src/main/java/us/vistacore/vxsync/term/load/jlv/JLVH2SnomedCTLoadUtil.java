...
public class JLVH2SnomedCTLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_TABLE = "CREATE TABLE IF NOT EXISTS snomedct (id INT PRIMARY KEY, " + 
	                                                                                   ...
	                                                                                   "name VARCHAR(500)," +
	                                                                                   "snomedId VARCHAR(20))";
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS SNOMEDCT_CONCEPTID_IDX on SNOMEDCT(CONCEPTID)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS SNOMEDCT_SNOMEDID_IDX on SNOMEDCT(SNOMEDID)";
