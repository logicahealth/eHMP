...
public class JLVH2VitalsLoadUtil implements IJLVH2PageLoadUtil {
	...
	private static final String SQL_CREATE_INDEX_1 = "CREATE INDEX IF NOT EXISTS VITALS_DODNCID_IDX on VITALS(DODNCID)";
	private static final String SQL_CREATE_INDEX_2 = "CREATE INDEX IF NOT EXISTS VITALS_VUID_IDX on VITALS(VUID)";
	private static final String SQL_CREATE_INDEX_3 = "CREATE INDEX IF NOT EXISTS VITALS_LOINC_IDX on VITALS(LOINC)";
	...
	private void prepareDatabase() throws SQLException {
		...
		this.oDBConnection.prepareCall(SQL_CREATE_INDEX_3).execute();
		this.oDBConnection.commit();
	}
