                        ...
                        <header id="titlebar" class="titlebar">
                            <div class="columns">
                                ...
                                <div class="col-2" style="text-align: right;word-wrap: break-word;">
                                    ...
                                    <b>Prepared</b>
                                    for
                                    <strong style="font-size:15px; word-wrap: break-word;">
                                        ...
                                        <tbody>
                                            ...
                                            <tr valign="top">
                                                ...
                                                <td>
                                                    <xsl:choose>
                                                        <xsl:when
                                                                test="n1:recordTarget/n1:patientRole/n1:patient/n1:maritalStatusCode">
                                                            <xsl:value-of
                                                                    select="n1:recordTarget/n1:patientRole/n1:patient/n1:maritalStatusCode" />
                                                        </xsl:when>
                                                        <xsl:otherwise>
