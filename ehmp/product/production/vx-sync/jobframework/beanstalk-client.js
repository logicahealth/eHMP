...
function makeBeanstalkCommand(command, expectedResponse, sendsData) {
    ...
    return function(args, data, callback) {
        ...
        this.logger.trace('beanstalk-client.%s(): Adding Response Handler to stack with params: %s, expectedResponse: %s, callback: %s', command, params, expectedResponse, callback.toString());
        this.handlers.push({
