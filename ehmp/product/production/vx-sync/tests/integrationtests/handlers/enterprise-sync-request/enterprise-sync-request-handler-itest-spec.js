...
describe('testSet', function() {
    describe('enterprise-sync-request-handler.js', function () {
        ...
        it('Set up and run test', function () {
            ...
            runs(function () {
                environment.jds.storePatientIdentifier({
                    ...
                    jpid = val(response, ['headers', 'location']);
                    if (jpid) {
                        jpid = jpid.replace(/(^http:\/\/.*\/vpr\/jpid\/)/, '');
                    }
        ...
        afterEach(function () {
            ...
            // var expectedPatientIdentifierValues = [ '5000000126V406128', 'SITE;100625', 'SITE;100625', 'HDR;5000000126V406128', 'DAS;5000000126V406128', 'VLER;5000000126V406128' ];
            var expectedPatientIdentifierValues = ['5000000126V406128', 'SITE;100625', 'SITE;100625', 'HDR;5000000126V406128', 'JPID;' + jpid, 'VLER;5000000126V406128'];
    ...
    describe('enterprise-sync-request-handler.js test 2', function () {
        var patientIdentifier = patientIdUtil.create('pid', 'SITE;239');
        var jpid;
        var job;
        var host = vx_sync_ip;
        var port = PORT;
        ...
        var matchingJobTypes = [
            ...
            jobUtil.hdrSyncRequestType(),
            // jobUtil.pgdSyncRequestType(),
            jobUtil.vlerDasSyncRequestType(),
            // jobUtil.jmeadowsSyncRequestType()    //SITE;239 does not have a DOD record
        ];
        it('Set up and run test', function () {
        ...
        afterEach(function () {
            var checkIdentifiersDone = false;
            // var expectedPatientIdentifierValues = [ '5000000126V406128', 'SITE;100625', 'SITE;100625', 'HDR;5000000126V406128', 'DAS;5000000126V406128', 'VLER;5000000126V406128' ];
            var expectedPatientIdentifierValues = ['11010V543403', 'SITE;239', 'SITE;239', 'HDR;11010V543403', 'JPID;' + jpid, 'VLER;11010V543403'];
