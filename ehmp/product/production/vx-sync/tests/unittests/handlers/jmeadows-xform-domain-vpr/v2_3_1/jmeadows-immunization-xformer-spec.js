...
var xformer = require(global.VX_HANDLERS + 'jmeadows-xform-domain-vpr/v2_3_1/jmeadows-immunization-xformer');
...
describe('jmeadows-immunization-xformer', function() {
    ...
    var sampleVPRImmunization = {
        ...
        administeredDateTime: '20140108000000',
        name: 'Anthrax',
        seriesName: '2',
        facilityName: 'DOD',
        facilityCode: 'DOD',
