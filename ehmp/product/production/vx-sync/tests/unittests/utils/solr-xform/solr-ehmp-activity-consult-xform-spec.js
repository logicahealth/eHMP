...
describe('solr-ehmp-activity-consult-xform.js', function () {
	describe('Transformer', function () {
		it('Happy Path', function () {
			var vprRecord = {
				...
				'data': {
					'activity': {
						...
						'clinicalObjectUid': 'urn:va:ehmp-activity:9E7A:239:29fe0301-14ac-4d8d-95a9-9f538866beba',
						'deploymentId': 'VistaCore:Order:0.0.0',
						'destinationFacilityId': '500',
						'domain': 'ehmp-activity',
						'initiator': 'urn:va:user:9E7A:10000000271',
					...
					'consultOrders': [{
								...
								'results': [{
									...
									'remediation': {
										...
										'coding': {
											'code': 'urn:va:oi:239',
											'display': 'C Reactive Protein',
											'system': 'urn:oid:2.16.840.1.113883.6.233:9E7A'
										},
										'domain': 'lab'
									},
									'status': 'Failed'
						...
						'conditions': [{
							'code': 'urn:va:problem:9E7A:239:773',
						...
						'orderResults': [{
							...
							'uid': 'urn:va:ehmp-order:9E7A:239:98c0b603-18eb-4f5e-8a3e-416147d355d3'
						}, {
							'ien': '252',
					...
					'signals': [{
						'data': '{"status":"urn:va:order-status:comp","uid":"urn:va:ehmp-order:9E7A:239:98c0b603-18eb-4f5e-8a3e-416147d355d3"}',
						'executionDateTime': '20170112161021+0000',
						'name': 'PREREQ.ORDER.UPDATE'
					}]
				},
			...
			expect(solrRecord.pid).toBe('9E7A;239');
