...
function unsubscribePatientData(pid, config, callback) {
    ...
    if (rpcConfig) {
        ...
        rpcUtil.standardRPCCall(rpcLog, rpcConfig, 'HMPDJFS DELSUB', params, null, function(error, response) {
...
function resubscribePatientData(pid, config, callback) {
    ...
    if (rpcConfig) {
        ...
        rpcUtil.standardRPCCall(rpcLog, rpcConfig, 'HMPDJFS API', params, null, function(error, response) {
