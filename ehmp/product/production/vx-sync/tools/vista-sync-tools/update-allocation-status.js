...
//--------------------------------------------------------------------------------------------------------
// This is a utility that can be used to update the status of an allocation that is currently reserved
// within a Vista system when running in multiple poller mode.
//
// @Author: Les Westberg
//--------------------------------------------------------------------------------------------------------
...
var argv = require('yargs')
    ...
    .demand(['site','allocation-token', 'allocation-status'])
    .string('site')
