...
function createPatientRecordRetirement(patientIdentifier, rootJob) {
...
function patientRecordRetirementType(){
...
fields[patientRecordRetirementType()] = ['patientIdentifier'];
