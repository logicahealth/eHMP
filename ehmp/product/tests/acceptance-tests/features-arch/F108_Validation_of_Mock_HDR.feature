@mock_hdr
Feature: F108 Create a Mock HDR

#This feature item creates a Mock HDR to support Development/Test validation of the HDR Synchronization.

Background:
	Given a patient with pid "11016V630869" has been synced through Admin API
		
@f108_1_create_mock_hdr_vitals 
...
@f108_3_create_mock_hdr_allergies 
...
@f108_4_create_mock_hdr_appointments 
...
@f108_5_create_mock_hdr_consults 
...
@f108_7_create_mock_hdr_documents 
...
@f108_8_create_mock_hdr_educations 
...
@f108_10_create_mock_hdr_factors 
...
@f108_11_create_mock_hdr_images 
...
@f108_12_create_mock_hdr_immunizations 
...
@f108_13_create_mock_hdr_mentalhealth 
...
@f108_14_create_mock_hdr_orders @hdrt1
...
@f108_15_create_mock_hdr_pointofvisits 
...
@f108_16_create_mock_hdr_problems 
...
@f108_17_create_mock_hdr_procedures 
...
@f108_19_create_mock_hdr_surgeries 
...
@f108_20_create_mock_hdr_visits 
