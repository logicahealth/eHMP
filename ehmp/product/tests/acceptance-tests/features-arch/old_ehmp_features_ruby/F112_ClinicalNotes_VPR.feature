...
Scenario: Client can request clinical Note in VPR format
	...
	Then the VPR results contain:
      ...
      | pid                            | CONTAINS ;100125                                           |
      | kind                           | Progress Note                                        |
      | text.uid                       | urn:va:document:SITE:100125:2258                     |
      | text.summary                   | DocumentText{uid='urn:va:document:SITE:100125:2258'} |
      ...
      | text.clinicians.uid            | urn:va:user:SITE:983                                 |
      | text.clinicians.summary        | DocumentClinician{uid='urn:va:user:SITE:11748'}      |
      | text.clinicians.name           | PROVIDER,ONE                                         |
      | text.clinicians.displayName    | Provider,One                                         |
      | text.clinicians.role           | S                                                    |
      | clinicians.uid                 | urn:va:user:SITE:983                                 |
      | clinicians.summary             | DocumentClinician{uid='urn:va:user:SITE:11748'}      |
      ...
      | documentDefUid                 | urn:va:doc-def:SITE:1261                             |
      | encounterUid                   | urn:va:visit:SITE:100125:3161                        |
