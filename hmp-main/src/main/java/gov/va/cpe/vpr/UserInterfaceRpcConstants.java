...
public class UserInterfaceRpcConstants {
    ...
    public static final String FRONT_CONTROLLER_CHAIN_RPC = "VPRCRPC RPCCHAIN";
    ...
    public static final String ORDERING_CONTROLLER_RPC = "VPRCORD RPC";
    ...
    public static final String VPR_PUT_DEMOGRAPHICS_RPC = "VPR PUT DEMOGRAPHICS";
    public static final String VPR_PUT_DEMOGRAPHICS_RPC_URI = "/" + VPR_UI_CONTEXT + "/" + VPR_PUT_DEMOGRAPHICS_RPC;

    public static final String VPR_DELETE_OBJECT_RPC = "VPR DELETE OBJECT";
    ...
    // Roster RPCs
    public static final String VPR_GET_SOURCE_RPC = "VPR GET SOURCE";
    public static final String VPR_GET_SOURCE_URI = "/" + VPR_UI_CONTEXT + "/" + VPR_GET_SOURCE_RPC;

    public static final String VPR_UPDATE_ROSTER_RPC = "VPR UPDATE ROSTER";
    public static final String VPR_UPDATE_ROSTER_URI = "/" + VPR_UI_CONTEXT + "/" + VPR_UPDATE_ROSTER_RPC;

    public static final String VPR_DELETE_ROSTER_RPC = "VPR DELETE ROSTER";
