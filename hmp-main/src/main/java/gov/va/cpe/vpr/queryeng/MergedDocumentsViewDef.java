	...
	public MergedDocumentsViewDef() {
        ...
        Query q1 = addQuery(new ScreenedJDSQuery("uid", querydef) {
            ...
            protected Map<String, Object> mapRow(RenderTask renderer, Map<String, Object> row) {
                ...
                // filter out types that are results, they will be pulled in with the
                // Procedure or Consult item that it belongs to
                List<String> removeMe = Arrays.asList("Consult Report", "Radiology Report", "Surgery Report");
                for(String kind : removeMe) {
