...
public class CDSLogging {
	...
	public static void debug(String myMessage) {
		System.out.println("DEBUG: CDSLogging: " + myMessage);
	}
	public static void error(String myMessage) {
		System.out.println("ERROR: CDSLogging: " + myMessage);
	}
	public static void warn(String myMessage) {
		System.out.println("WARN: CDSLogging: " + myMessage);
	}
	public static void info(String myMessage) {
		System.out.println("INFO: CDSLogging: " + myMessage);
	}
}
