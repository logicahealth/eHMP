...
public class ErrorResponseUtilTest {
	...
	public void validateErrorConstruction() throws JSONException {
		String actual = ErrorResponseUtil.createJsonErrorResponse(HttpStatus.BAD_REQUEST, "Bogus Message", null);
	...
	public void validateErrorConstructionNullHttpStatus() throws JSONException {
		String actual = ErrorResponseUtil.createJsonErrorResponse(null, "Bogus Message", null);
	...
	public void validateErrorConstructionNullMessage() throws JSONException {
		String actual = ErrorResponseUtil.createJsonErrorResponse(HttpStatus.BAD_REQUEST, null, null);
	...
	public void validateErrorConstructionEmptyMessage() throws JSONException {
		String actual = ErrorResponseUtil.createJsonErrorResponse(HttpStatus.BAD_REQUEST, "", null);
		String expected = "{\"error\": \"\",\"additionalErrorInfo\":\"UNKNOWN ERROR - ERROR MESSAGE WAS NOT SUPPLIED\",\"status\": 400}";
		JSONAssert.assertEquals(expected, actual, true);
	}
	@Test
	public void validateErrorConstructionServerMessageJson() throws JSONException {
		String actual = ErrorResponseUtil.createJsonErrorResponse(HttpStatus.BAD_REQUEST, "Bogus Message", "{\"message\": \"KieRemoteRestOperationException thrown with message 'No deployments available for BOGUS'\",\"status\": 400}");
	...
	public void validateErrorConstructionServerMessageString() throws JSONException {
		...
		String actual = ErrorResponseUtil.createJsonErrorResponse(HttpStatus.BAD_REQUEST, "Bogus Message", serverResponse);
