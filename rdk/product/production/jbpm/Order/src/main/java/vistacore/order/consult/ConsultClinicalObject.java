...
public class ConsultClinicalObject implements java.io.Serializable
{
   ...
   public void setData(vistacore.order.consult.ConsultClinicalObjectData data)
   {
      this.data = data;
   }
