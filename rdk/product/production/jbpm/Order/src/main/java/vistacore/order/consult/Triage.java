...
public class Triage implements java.io.Serializable
{
   ...
   private vistacore.order.Provider attentionProvider;
   ...
   public vistacore.order.Provider getAttentionProvider()
   {
      return this.attentionProvider;
   }

   public void setAttentionProvider(vistacore.order.Provider attentionProvider)
   {
   ...
   public Triage(java.lang.String comment, java.lang.String request,
         vistacore.order.Provider attentionProvider,
