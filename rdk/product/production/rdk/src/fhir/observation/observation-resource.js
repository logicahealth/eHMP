 ...
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_count=1
 *
 *      // Exact date search
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=2015-01-26T13:45:00
 *
 *      // Observations on a day
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=2015-01-26
 *
 *      // Observations on a month
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=2015-01
 *
 *      // Observations on a year
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=2015
 *
 *      // Observations outside a date range (e.g. observations not occuring on January 2015)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=!=2015-01
 *
 *      // Explicit date range
 *      http://IP           /resource/fhir/patient/SITE;253/observation?date=>=2014-06&date=<=2014-09-20
 *
 *      // Observations of a particular code
 *      http://IP           /resource/fhir/patient/SITE;253/observation?code=9279-1
 *
 *      // Observations of a particular code and system
 *      http://IP           /resource/fhir/patient/SITE;253/observation?code=http://loinc.org|9279-1
 *
 *      // Observations sorted by date (sorts by Observation.appliesDateTime)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort=date
 *
 *      // Observations sorted by identifier (sorts by Observation.identifier.value)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort=identifier
 *
 *      // Observations sorted by performer (sorts by Observation.performer.display)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort=performer
 *
 *      // Observations sorted by subject (sorts by Observation.subject.reference)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort=subject
 *
 *      // Observations sorted by value-quantity (sorts by Observation.valueQuantity.value)
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort=value-quantity
 *
 *      // Observations sorted by value-quantity in descending order
 *      http://IP           /resource/fhir/patient/SITE;253/observation?_sort:desc=value-quantity
 *
 ...
 *         {
 *             "rel": "self",
 *             "href": "http://IP      /resource/fhir/patient/SITE;253/observation?date=%3E2015-01-26T01:20:00Z&code=http://loinc.org|8310-5&_count=1"
 *         }
 *     ],
 *     "meta": {
 ...
 *                     "value": "urn:va:vital:SITE:253:28425"
 *                 },
 *                 "subject": {
