...
/**
 * Calls the RPC 'PXVIMM ADMIN ROUTE' and parses out the data<br/><br/>
 *
 * <table border="1">
...
module.exports.fetch = function(logger, configuration, callback, params) {
    ...
    return rpcUtil.standardRPCCall(logger, configuration, 'PXVIMM ADMIN ROUTE', filter, date, parse, callback);
};
