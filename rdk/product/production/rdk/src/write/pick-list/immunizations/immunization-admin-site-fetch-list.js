...
/**
 * Calls the RPC 'PXVIMM ADMIN SITE' and parses out the data<br/><br/>
 *
 * <table border="1">
...
module.exports.fetch = function(logger, configuration, callback, params) {
    ...
    return rpcUtil.standardRPCCall(logger, configuration, 'PXVIMM ADMIN SITE', filter, date, parse, callback);
};
