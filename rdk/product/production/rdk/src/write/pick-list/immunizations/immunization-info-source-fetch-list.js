...
/**
 * Calls the RPC 'PXVIMM INFO SOURCE' and parses out the data<br/><br/>
 *
 * <table border="1">
...
module.exports.fetch = function(logger, configuration, callback, params) {
    ...
    return rpcUtil.standardRPCCall(logger, configuration, 'PXVIMM INFO SOURCE', filter, date, parse, callback);
};
