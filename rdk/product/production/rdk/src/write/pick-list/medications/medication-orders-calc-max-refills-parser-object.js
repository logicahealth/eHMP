...
/**
 * Takes the return string from the RPC 'ORWDPS2 MAXREF' and parses out the data.<br/><br/>
 *
...
module.exports.parse = function(logger, rpcData) {
    ...
    if (lines.length === 0) {
        ...
        if (fields.length !== 1) {
            throw new Error('The RPC "ORWDPS2 MAXREF" returned data but we couldn\'t understand it: ' + lines[0]);
        }
