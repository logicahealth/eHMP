...
@US1962_MedicationWriteBack @US1962 @onc
  ...
  Then the new Non-VA Med order can be discontinued for patient "SITE;271" with reason "7", location IEN "64" and provider IEN "10000000225"
  And the response contains ""success":true"
