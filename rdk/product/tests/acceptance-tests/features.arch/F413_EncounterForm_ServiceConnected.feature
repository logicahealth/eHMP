...
Scenario: A request for Ten,Patient's service connected and rated disabilities successfully returns data
	When the client requests service connected and rated disabilities information for user "REDACTED" and patient id "9E7A;8"
...
Scenario: A request for Eight,Patient's service connected and rated disabilities returns no data
	When the client requests service connected and rated disabilities information for user "REDACTED" and patient id "9E7A;3"
	Then a successful response is returned
...
Scenario: A request for Ten,Patient's service exposure list successfully returns data
	When the client requests service connected exposure information for user "REDACTED" and patient id "9E7A;101"
	Then a successful response is returned
