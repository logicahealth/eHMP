...
Scenario: Endpoint for Vaccine Information Statement File (PXVIMM VIS)
  When the client requests picklist with the parameters for "immunization-vaccine-info-statement" with the user "SITE;USER  "
      | paramter name | value                               |
...
Scenario: Endpoint for Immunization Info Source File (PXVIMM INFO SOURCE)
  When the client requests picklist with the parameters for "immunization-info-source" with the user "SITE;USER  "
      | paramter name | value                    |
...
Scenario: Endpoint for Immunization Administration Route File (PXVIMM ADMIN ROUTE)
  When the client requests picklist with the parameters for "immunization-admin-route" with the user "SITE;USER  "
      | paramter name | value                    |
...
Scenario: Endpoint for Immunization Administration Site File (PXVIMM ADMIN SITE)
  When the client requests picklist with the parameters for "immunization-admin-site" with the user "SITE;USER  "
      | paramter name | value                    |
...
Scenario: Endpoint for Immunization Manufacturers File (PXVIMM IMM MAN)
  When the client requests picklist with the parameters for "immunization-manufacturer" with the user "SITE;USER  "
      | paramter name | value                     |
...
Scenario: | Endpoint for Immunization Lot File (PXVIMM IMM LOT)
  When the client requests picklist with the parameters for "immunization-lot" with the user "SITE;USER  "
      | paramter name | value            |
...
Scenario: | Endpoint for Immunization Data (PXVIMM IMMDATA)
  When the client requests picklist with the parameters for "immunization-data" with the user "SITE;USER  "
      | paramter name | value             |
