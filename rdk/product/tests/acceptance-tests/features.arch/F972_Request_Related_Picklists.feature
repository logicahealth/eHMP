...
Scenario: Fetch facilities pick-list
  When the client requests picklist with the parameters for "facilities" with the user "9E7A;PW    "
...
Scenario: Fetch people-for-facility pick-list
  When the client requests picklist with the parameters for "people-for-facility" with the user "9E7A;PW    "
  | parameter name | value               |
  | facilityID     | 500                 |
  Then a successful response is returned
  And the picklist result contains
...
Scenario: Fetch roles pick-list
  When the client requests picklist with the parameters for "roles-for-team" with the user "9E7A;PW    "
  | parameter name | value          |
  | teamID         | 1128           |
  Then a successful response is returned
  And the picklist result contains
...
Scenario: Fetch teams-for-facility pick-list
  When the client requests picklist with the parameters for "teams-for-facility" with the user "9E7A;PW    "
  | parameter name | value              |
  | facilityID     | 500                |
  Then a successful response is returned
  And the picklist result contains
...
Scenario: Fetch teams-for-user pick-list
  When the client requests picklist with the parameters for "teams-for-user" with the user "9E7A;PW    "
  | parameter name | value          |
  | staffIEN       | 9037           |
  Then a successful response is returned
  And the picklist result contains
...
Scenario: Fetch teams-for-user-patient-related pick-list
  When the client requests picklist with the parameters for "teams-for-user-patient-related" with the user "9E7A;PW    "
  | parameter name | value                          |
  | staffIEN       | 9037                           |
  | patientID      | 666965487                      |
  Then a successful response is returned
...
Scenario: Fetch teams-for-facility-patient-related pick-list
  When the client requests picklist with the parameters for "teams-for-facility-patient-related" with the user "9E7A;PW    "
  | parameter name | value                              |
  | facilityID     | 500                                |
  | patientID      | 666223456                          |
  Then a successful response is returned
