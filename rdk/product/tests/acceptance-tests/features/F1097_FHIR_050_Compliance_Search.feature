 ...
 When the client use GET requests with compartment-style for patient "9E7A;204" of "condition"
 ...
 When the client use POST requests with compartment-style for patient "9E7A;204" of "condition"
 Then a successful response is returned
 And the returned json data meet the requirement of FHIR050_Condition
 And required element "resourceType" is "condition" returned
 ...
 When the client use GET requests with direct-resource-access-style for patient "9E7A;204" of "composition"
 Then a successful response is returned
 And the returned json data meet the requirement of FHIR050_Condition
 ...
 When the client use POST requests with direct-resource-access-style for patient "9E7A;204" of "composition"
 Then a successful response is returned
 And the returned json data meet the requirement of FHIR050_Condition
 And required element "resourceType" is "composition" returned  
