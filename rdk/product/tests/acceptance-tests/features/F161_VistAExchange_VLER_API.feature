...
Scenario: For a patient a collection of data is made successfully
	...
	Then a successful response is returned
	Then in section "problems" the response contains 18 "problem"s
	...
	Then in section "allergies" the response contains 6 "allergy"s
	Then in section "medications" the response contains 44 "medication"s
	Then in section "vitalsigns" the response contains 302 "vitalsign"s
	Then in section "procedures" the response contains 30 "procedure"s
	Then in section "immunizations" the response contains 4 "immunization"s
	Then in section "results" the response contains 2 "imaging"s
