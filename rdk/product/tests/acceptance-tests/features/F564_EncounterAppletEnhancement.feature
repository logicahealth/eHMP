...
@F295__timeline_Admitting_Discharge_Diagnosis @F564-1 @F564-2 @VPR @US5650 @SITE8
...
When the client requests timeline for the patient "SITE;8" in RDK format
Then a successful response is returned
And the VPR results contain
      | field                        | value                           |
      | uid                          | urn:va:visit:SITE:8:H493        |
      | dischargeDiagnoses.admissionUid      | urn:va:visit:SITE:8:H493        |
      ...
      | dischargeDiagnoses.pid               | SITE;8                          |
      | dischargeDiagnoses.principalDx       | true                            |
      | dischargeDiagnoses.stampTime         | 19920128160000                  |
      | dischargeDiagnoses.uid               | urn:va:ptf:SITE:8:130;70;DXLS   |
