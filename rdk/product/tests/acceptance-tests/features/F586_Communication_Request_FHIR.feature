...
Scenario: retrieve all requests for a recipient
    Given the system knows about the following communication requests for the "patient%2FSITE;10045" recipient
    | category                      | sender                   | medium                     | recipient          | payload                    | status    | reason                      | subject            | priority               |
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/1 | ehmp/msg/medium/ui/inline  | patient/SITE;10045 | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/high |
    | ehmp/msg/category/operational | ehmp/activity/45/task/3  | ehmp/msg/medium/ui/overlay | patient/SITE;10045 | patient/SITE;data/543      | requested | ehmp/msg/reason/information | patient/SITE;10045 | ehmp/msg/priority/low  |
    When the client retrieves all communication requests for recipient "patient%2FSITE;10045"
    And one of the communication request has the following data:
     	| field 					       	    | value                    				     |
      	...
      	| sender.reference                      | ehmp/activity/123/task/1                   |
       	...
       	| recipient.reference                   | patient/SITE;10045                         |
       	| payload.contentReference.reference    | patient/SITE;10045/lab/123                 |
       	| status                                | requested                                  |
       	| reason.coding.code                    | ehmp/msg/reason/decision                   |
       	| subject.reference                     | patient/SITE;10045                         |
    ...
    And one of the communication request has the following data:
     	| field 					       	    | value                    				     |
      	...
      	| sender.reference                      | ehmp/activity/45/task/3                    |
       	...
       	| recipient.reference                   | patient/SITE;10045                         |
       	| payload.contentReference.reference    | patient/SITE;data/543                      |
       	| status                                | requested                                  |
       	| reason.coding.code                    | ehmp/msg/reason/information                |
       	| subject.reference                     | patient/SITE;10045                         |
       	| priority.coding.code                  | ehmp/msg/priority/low                      |
    And remove all communication requests for recipient "patient%2FSITE;10045"
...
Scenario: delete all requests for a recipient
    ...
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/1 | ehmp/msg/medium/ui/inline  | patient/SITE;10045 | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/high |
    | ehmp/msg/category/operational | ehmp/activity/45/task/3  | ehmp/msg/medium/ui/overlay | patient/SITE;10045 | patient/SITE;data/543      | requested | ehmp/msg/reason/information | patient/SITE;10045 | ehmp/msg/priority/low  |
    Then remove all communication requests for recipient "patient%2FSITE;10045"
...
Scenario: retrieve a single request for a recipient
    Given the system knows about the following communication requests for the "provider%2FUSER  " recipient
    | category                      | sender                   | medium                     | recipient          | payload                    | status    | reason                      | subject            | priority           |
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/5 | ehmp/msg/medium/ui/inline  | provider/USER      | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/high |
    When the client retrieves a communication request for recipient "provider%2FUSER  " with the resource id
    Then a successful response is returned
    And the communication request contains
     	| field 					       	    | value                    				     |
      	...
      	| sender.reference                      | ehmp/activity/123/task/5                   |
       	| category.coding.code                  | ehmp/msg/category/clinical                 |
       	| medium.coding.code                    | ehmp/msg/medium/ui/inline             		 |
       	| recipient.reference                   | provider/USER                              |
       	| payload.contentReference.reference    | patient/SITE;10045/lab/123                 |
       	| status                                | requested                                  |
       	| reason.coding.code                    | ehmp/msg/reason/decision                   |
       	| subject.reference                     | patient/SITE;10045                         |
       	| priority.coding.code                  | ehmp/msg/priority/high                     |
    And remove all communication requests for recipient "provider%2FUSER  "
...
Scenario: delete a single request for a recipient
    ...
    | category                      | sender                   | medium                     | recipient          | payload                    | status    | reason                      | subject            | priority           |
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/5 | ehmp/msg/medium/ui/inline  | provider/USER      | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/high |
    When the client deletes the communication request for recipient "provider%2FUSER  " with a resource id
...
Scenario: not found when retrieving a single request for a recipient that does not exist
    ...
    When the client retrieves a communication request for recipient "provider%2FUSER  " with an unknown resource id
...
Scenario: try to add a bad request
    ...
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/1 | ehmp/msg/medium/ui/inline  | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/high |
...
Scenario: try to add a unprocessible request
    ...
    When trying to add an invalid communication requests
    | category                      | sender                   | medium                     | recipient          | payload                    | status    | reason                      | subject            | priority                |
    | ehmp/msg/category/clinical    | ehmp/activity/123/task/1 | ehmp/msg/medium/ui/inline  | patient/SITE;10045 | patient/SITE;10045/lab/123 | requested | ehmp/msg/reason/decision    | patient/SITE;10045 | ehmp/msg/priority/alert |
