...
Scenario: Search Complex Note 1
  ...
  When the client searches complex notes for pid of "SITE;3" and uid of "urn:va:document:DOD:0000000003:1000000648"
...
Scenario: Complex Note not found
  When the client searches complex notes for pid of "SITE;100125" and uid of "urn:va:document:DOD:0000000003:1000000648"
...
Scenario: Search Complex Note With uid that is a non-complex document
  When the client searches complex notes for pid of "SITE;3" and uid of "urn:va:document:SITE:3:2745"
  Then a non-found response is returned
