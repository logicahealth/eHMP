...
Scenario: Search Domain lab with start date
  ...
  When the client searches domain "lab" by type for pid = "SITE;3" and type = "HGB" and date.start = "20150101"
...
Scenario: Search Domain lab #2
  ...
  When the client searches domain "immunization" by type for pid = "SITE;100125" and type = "PNEUMOCOCCAL" and date.start "19990101"
  Then a successful response is returned
...
Scenario: Search Domain vital
  ...
  When the client searches domain "vital" by type for pid = "SITE;253" and type = "TEMPERATURE" and date.start = "20150101"
  Then a successful response is returned
  And the response contains at least 2 items
...
Scenario: Search Domain with no match in date range
  Given a patient with pid "SITE;253" has been synced through the RDK API
  When the client searches domain "vital" by type for pid = "SITE;253", type = "TEMPERATURE", date.start = "20150101000000", and date.end = "20150128000000"
  Then a successful response is returned
...
Scenario: Search with match in date range
  Given a patient with pid "SITE;253" has been synced through the RDK API
  When the client searches domain "vital" by type for pid = "SITE;253", type = "TEMPERATURE", date.start = "20150201000000", and date.end = "20150228000000"
  Then a successful response is returned
...
Scenario: Search non-existing type
  Given a patient with pid "SITE;253" has been synced through the RDK API
  When the client searches domain "vital" by type for pid = "SITE;253", type = "NOT-EXIST"
  Then a successful response is returned
...
Scenario: Search Domain lab without start date
  Given a patient with pid "SITE;3" has been synced through the RDK API
  When the client searches domain "lab" by type for pid = "SITE;3" and type = "HGB"
  Then a successful response is returned
