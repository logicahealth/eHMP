...
Scenario: Search Detail Document with existing pid but no matches
  When the client requests authentication with accessCode "REDACTED" and verifyCode "REDACTED" and site "C877" and division "507" and contentType "application/json"
