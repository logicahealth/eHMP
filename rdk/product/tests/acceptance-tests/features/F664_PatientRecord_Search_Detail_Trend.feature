...
Scenario: Search Detail Trend med
  ...
  When the client searches detailed trends for pid "SITE;8" with uid "urn:va:med:SITE:8:8145"
...
Scenario: Search Detail Trend
  ...
  When the client searches detailed trends for pid "SITE;100125" with uid "urn:va:med:9016:5000000009V082878:5587940"
  Then a successful response is returned
...
Scenario: Search Detail Trend with non-existing uid
  Given a patient with pid "SITE;100125" has been synced through the RDK API
  When the client searches detailed trends for pid "SITE;100125" with uid "urn:va:med:9016:5000000009V082878:0000"
...
Scenario: Search Detail Trend with non-existing pid
  When the client searches detailed trends for pid "SITE;5000000009" with uid "urn:va:med:9016:5000000009V082878:5587940"
  Then a non-found response is returned

@F664_PatientRecord_Search_Detail_Trend_Scenario_5
Scenario: Search Detail Trend with uid of different pid
  Given a patient with pid "SITE;100125" has been synced through the RDK API
  When the client searches detailed trends for pid "SITE;100125" with uid "urn:va:med:SITE:8:8145"
  Then a non-found response is returned
