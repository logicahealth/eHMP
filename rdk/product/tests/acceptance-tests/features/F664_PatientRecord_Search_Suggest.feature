...
Scenario: Search Text Suggestion of lower case single word
  ...
  When the client searches text suggestions for pid "9E7A;3" and query "blood"
...
Scenario: Search Text Suggestion of site with upper case word
  When the client searches text suggestions for pid "9E7A;100816" and query "PRESSURE"
  Then a successful response is returned
...
Scenario: Search Text Suggestion of multiple words
  ...
  When the client searches text suggestions for pid "9E7A;253" and query "beta blockers"
  Then a successful response is returned
...
Scenario: Search Text Suggestion of non-existing pid
  When the client searches text suggestions for pid "C877;8484" and query "blood"
...
Scenario: Search Text Suggestion of mixed-case word
  Given a patient with pid "9E7A;3" has been synced through the RDK API
  When the client searches text suggestions for pid "9E7A;3" and query "prEssUrE"
  Then a successful response is returned
  And the response contains at least 2 items
...
Scenario: Search Text Suggestion of non-matching query
  Given a patient with pid "9E7A;253" has been synced through the RDK API
  When the client searches text suggestions for pid "9E7A;253" and query "xxxxxx yyyyy"
  Then a successful response is returned
