...
Scenario:
  ...
  When the "9E7A;PW    " client requests tasks instances for "user" and "teamroles"
  ...
  When the "9E7A;PW    " client requests the sign update start
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | start                        |
   Then a successful response is returned

  When the "9E7A;PW    " client signs the consult order
      | parameter | value                        |
      | pid       | 9E7A;100728                  |
      | site      | 9E7A                         |
  ...
  When the "9E7A;PW    " client requests the task is updated to be signed
      | parameter                    | value                        |
...
Scenario: 
  ...
  And the user "9E7A;PW    " signals to activate order
      | parameter | value                        |
      | userId    | urn:va:user:9E7A:10000000272 |
    
  When the user "9E7A;PW    " requests to update task to eConsult (start)
      | parameter          | value            |
      | icn                | 9E7A;100728      |
      | state              | start            |

  Then a successful response is returned
  When the user "9E7A;PW    " requests to update task to eConsult
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | complete                     |
      | orderingProvider displayName | KHAN, VIHAAN                 |
  ...
  When the "9E7A;PW    " client requests tasks instances for "patient" and "teamroles" for patient "9E7A;100728"
  Then a successful response is returned
  And the task associated with the processInstanceId has
  | parameter  | value             |
...
Scenario: 
  ...
  And the user "9E7A;PW    " signals to activate order
      | parameter | value                        |
      | userId    | urn:va:user:9E7A:10000000272 |
  When the user "9E7A;PW    " requests to update task to Return for Clarafication (start)
      | parameter          | value            |
      | icn                | 9E7A;100728      |
      | state              | start            |
  Then a successful response is returned
  When the user "9E7A;PW    " requests to update task to Return for Clarafication
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | complete                     |
      | orderingProvider displayName | KHAN, VIHAAN                 |
...
Scenario:
  ...
  And the user "9E7A;PW    " signals to activate order
      | parameter | value                        |
      | userId    | urn:va:user:9E7A:10000000272 |
  When the user "9E7A;PW    " requests to update task to Referred to Community Care (start)
      | parameter          | value            |
      | icn                | 9E7A;100728      |
      | state              | start            |
  Then a successful response is returned
  When the user "9E7A;PW    " requests to update task to Referred to Community Care
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | complete                     |
      | orderingProvider displayName | KHAN, VIHAAN                 |
...
Scenario: 
  ...
  When the user "9E7A;PW    " requests to update task to Assign to triage member (start)
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | start                        |
  Then a successful response is returned
  When the user "9E7A;PW    " requests to update task to Assign to triage member
      | parameter                     | value                        |
      | icn                           | 9E7A;100728                  |
      | state                         | complete                     |
...
Scenario: 
  ...
  And the client has the current deploymentid
  And the user 9E7A;PW     has created and signed a consult for patient "9E7A;100728"
  When the user "9E7A;PW    " requests to update task to Send to Scheduling (start)
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | start                        |
  Then a successful response is returned
  When the user "9E7A;PW    " requests to update task to Send to Scheduling
      | parameter                    | value                        |
      | icn                          | 9E7A;100728                  |
      | state                        | complete                     |
      | orderingProvider displayName | KHAN, VIHAAN                 |
