...
Scenario:  
  ...
  When the client requests activities instances for pid "9E7A;3"
  Then a successful response is returned
...
Scenario: 
  ...
  When the client starts an activity on patient "9E7A;3"
  Then a successful response is returned
...
Scenario:
  ...
  When the client requests a single instance activity for pid "9E7A;3"
  Then a successful response is returned
