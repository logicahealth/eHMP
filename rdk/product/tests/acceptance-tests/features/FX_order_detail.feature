...
Scenario: first order
  ...
  And the client requests all-orders for the patient "SITE;100022"
  And a successful response is returned
  And the response contains at least 1 items
  And the client notes the first order localId
  When the client requests orders detail lab with saved localId for patient "SITE;100022"
  And a successful response is returned
...
Scenario: client can request single consult
  ...
  And the client requests all-orders for the patient "SITE;3"
  And a successful response is returned
  And the response contains at least 1 items
  And the client notes the first order localId for kind "Consult"
  When the client requests orders detail lab with saved localId for patient "SITE;3"
  And a successful response is returned
...
Scenario: client can request single Medication, Infusion
  ...
  And the client requests all-orders for the patient "SITE;8"
  And a successful response is returned
  And the response contains at least 1 items
  And the client notes the first order localId for kind "Medication, Infusion"
  When the client requests orders detail lab with saved localId for patient "SITE;8"
  And a successful response is returned
