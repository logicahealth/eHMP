...
Then(/^I am able to retrieve comm requests for provider "([^"]*)"$/) do |provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/9E7A;10000000270
  resource = RDKQuery.new('communicationrequest-add')
...
Then(/^I am able to retrieve comm requests for patient "([^"]*)" of provider "([^"]*)"$/) do |patient, provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/9E7A;10000000270?subject=patient/9E7A;253
  resource = RDKQuery.new('communicationrequest-add')
...
Then(/^I am able to retrieve counters for unread notifications for provider "([^"]*)"$/) do |provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/9E7A;10000000270&status=received&count=true
  resource = RDKQuery.new('communicationrequest-add')
...
Then(/^I am able to retrieve lists of unread notifications for provider "([^"]*)"$/) do |provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/9E7A;10000000270?status=received
  resource = RDKQuery.new('communicationrequest-add')
...
Then(/^I am able to mark a notification as read as provider "([^"]*)"$/) do |provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/setstatus/read/9E7A;10000000270/<ID>
  type = { 'Content-Type' => 'application/json' }
  resource = RDKQuery.new('communicationrequest-add')
...
Then(/^I am able to mark a notification as completed as provider "([^"]*)"$/) do |provider|
  #http://IP_ADDRESS:PORT/resource/fhir/communicationrequest/setstatus/completed/9E7A;10000000270/<ID>
  type = { 'Content-Type' => 'application/json' }
  resource = RDKQuery.new('communicationrequest-add')
